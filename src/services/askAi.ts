...
Bottom tabs: Home, Inventory, Billing, Records, More.
- Make a sale / create a bill: open the "Billing" tab (New Bill), add products (scan barcode or search), pick payment mode (Cash / UPI / Credit-udhaar), then Save. Saved bills appear in the "Records" tab (Bill History).
